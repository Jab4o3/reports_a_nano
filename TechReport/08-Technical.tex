...
That being said, there is one major difference. The buffer size, which was limited to 100 when set through the WaveForms app, is actually 4096. This allows for pulse durations that fit the formula $\tau_{las} = x\frac{T_{seq}}{4096}$, for $x \in \mathbb{Z}^+$ and $x \leq 4096$.
