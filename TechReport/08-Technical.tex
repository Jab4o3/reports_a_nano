...
Achieving a critically-damped system, can be done by getting the roots of the general form (as seen in Equation \ref{eq:td:pole_roots_general}) and using the imaginary parts to get Equation \ref{eq:td:cap_solve}. While the expression cannot be solved analytically, the best capacitor can be found by solving it while varying the capacitance.
