...
\lstdefinelanguage{pythe}{
	...
	*{0}{{{\color{numb}0}}}{1}
	...
	morecomment=[l][\color{gray}]{\#},
	morestring=[b][\color{violet}]",
	morekeywords={const, byte, void, char, int, float, c_int, c_string, c_double, c_char, c_byte, def, for, while, in, is, None, True, False, not, if, else, elif, return, pass, continue, print, self}, keywordstyle=\color{red},
}
