...
\begin{figure}[ht]
	...
	\end{subfigure}
	\caption{Reverse-bias photodiode configurations}
...
The capacitance of $C_1$ can be calculated using the resistance of $R_1$ and the cutoff frequency $f_{rc}$, as shown in Equation \eqref{eq:c1}. 
