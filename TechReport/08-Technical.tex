...
dwf.FDwfAnalogOutRunSet(self.hdwf, self.laser_channel, c_double(run_time / f_pattern)) # set the run and wait time (in seconds)
...
To measure test data in the simplest way possible, it is crucial that whatever lock-in amplifier is used to boost the photodetector signal outputs to the Analog Discovery oscilloscope, as shown in Figure \ref{fig:td:ad2}. Th 
